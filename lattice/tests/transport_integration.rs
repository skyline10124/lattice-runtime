...
use lattice::core::transport::anthropic::AnthropicTransport;
use lattice::core::transport::chat_completions::ChatCompletionsTransport;
use lattice::core::transport::dispatcher::TransportDispatcher;
use lattice::core::transport::gemini::GeminiTransport;
use lattice::core::transport::Transport;
...
mod gemini {
    use super::*;
    use lattice::core::transport::gemini::StreamChunk;
