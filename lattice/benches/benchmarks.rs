...
use lattice::core::catalog::{
    ApiProtocol, CatalogProviderEntry, CredentialStatus, ModelCatalogEntry, ResolvedModel,
};
use lattice::core::router::ModelRouter;
use lattice::core::streaming::TokenUsage;
...
fn bench_streaming_parse(c: &mut Criterion) {
    ...
    group.bench_function("parse_raw_sse_20_events", |b| {
        b.iter(|| lattice::core::streaming::parse_raw_sse(black_box(&raw_sse_input)))
    });
...
fn bench_model_resolution(c: &mut Criterion) {
    ...
    group.bench_function("normalize_model_id_simple", |b| {
        b.iter(|| lattice::core::router::normalize_model_id(black_box("gpt-4o")))
    });

    group.bench_function("normalize_model_id_complex", |b| {
        b.iter(|| {
            lattice::core::router::normalize_model_id(black_box(
    ...
    group.bench_function("estimate_text_1kb", |b| {
        ...
        b.iter(|| lattice::core::tokens::TokenEstimator::estimate_text(black_box(&text)))
    });
