...
/// Re-export of the unified [`crate::core::transport::Transport`] trait.
...
impl Transport for ChatCompletionsTransport {
    ...
    fn denormalize_response(
                ...
                tcs.iter()
                    .filter_map(|tc| {
                        ...
                        let arguments = tc["function"]["arguments"]
                            ...
                            .to_string();
                        Some(crate::core::types::ToolCall {
                            id,
                            function: crate::core::types::FunctionCall { name, arguments },
                        })
                    })
                    .collect::<Vec<_>>()
            })
        ...
        let usage = response["usage"]
            .as_object()
            .map(|u| crate::core::streaming::TokenUsage {
...
mod tests {
    ...
    use crate::core::types::{Message, Role, ToolDefinition};
    use std::collections::HashMap;
    ...
    fn test_normalize_simple_request() {
        ...
        let request = ChatRequest {
            ...
            resolved: crate::core::catalog::ResolvedModel {
                ...
                credential_status: crate::core::catalog::CredentialStatus::Present,
            },
        };
    ...
    fn test_normalize_request_with_tools() {
        ...
        let request = ChatRequest {
            ...
            resolved: crate::core::catalog::ResolvedModel {
                ...
                context_length: 128000,
                provider_specific: HashMap::new(),
                credential_status: crate::core::catalog::CredentialStatus::Missing,
            },
        };
