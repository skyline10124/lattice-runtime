...
use crate::core::catalog::{ApiProtocol, ResolvedModel};
use crate::core::transport::anthropic::AnthropicTransport;
use crate::core::transport::chat_completions::{ChatCompletionsTransport, Transport};
use crate::core::transport::gemini::GeminiTransport;
...
///
/// ```ignore
/// use lattice::core::transport::dispatcher::create_transport;
/// use lattice::core::catalog::ApiProtocol;
///
...
mod tests {
    ...
    use crate::core::provider::ChatRequest;
    use std::collections::HashMap;
