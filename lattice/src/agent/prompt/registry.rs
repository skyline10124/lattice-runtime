...
use crate::agent::prompt::system_stack::{SystemPromptDelta, SystemPromptStack};
use crate::agent::prompt::types::*;
...
impl PromptRegistry {
    ...
    pub async fn collect(
        ...
        let tokens = crate::core::tokens::TokenEstimator::estimate_text(&system_prompt);
...
mod tests {
    ...
    fn make_resolved(cl: u32) -> crate::core::ResolvedModel {
        crate::core::ResolvedModel {
            canonical_id: "test".into(),
            provider: "test".into(),
            api_key: None,
            base_url: "".into(),
            api_protocol: crate::core::catalog::ApiProtocol::OpenAiChat,
