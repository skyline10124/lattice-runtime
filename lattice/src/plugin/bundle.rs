...
use crate::plugin::{Behavior, StrictBehavior, YoloBehavior};

pub use crate::core::types::{BehaviorMode, YoloSandboxPolicy};
...
pub fn effective_sandbox(
    ...
    base: &crate::tools::sandbox::SandboxConfig,
) -> crate::tools::sandbox::SandboxConfig {
    match behavior {
