...
//! live in [`crate::agent::tool_definitions`]. This module provides the execution
...
pub trait RegistryToolAccess: Send + Sync {
    ...
    fn get_definitions(&self) -> Vec<crate::core::types::ToolDefinition>;
}
...
pub struct DefaultToolExecutor {
    ...
    pub blob_store: Option<std::sync::Arc<crate::agent::blob::BlobStore>>,
}
...
impl DefaultToolExecutor {
    ...
    pub fn new_with_blob_store(
        project_root: &str,
        blob_store: Option<std::sync::Arc<crate::agent::blob::BlobStore>>,
    ) -> Result<Self, String> {
        Ok(Self {
            project_root: project_root.to_string(),
            sandbox: SandboxConfig::default(),
...
impl ToolExecutor for DefaultToolExecutor {
    async fn execute(&self, call: &crate::core::types::ToolCall) -> String {
...
async fn grep_recursive(
    ...
    sandbox: &crate::tools::sandbox::SandboxConfig,
    depth: u32,
