...
pub trait PluginAgent {
    ...
    fn set_system_prompt_delta(&mut self, _delta: Option<crate::prompt::SystemPromptDelta>) {}
    fn set_output_contract_delta(&mut self, _delta: Option<crate::prompt::SystemPromptDelta>) {}
    fn add_tools(&mut self, _tools: Vec<lattice_core::types::ToolDefinition>) {}
...
pub use tools::RegistryToolAccess;
...
/// [`lattice_core::chat()`] which uses `reqwest` — a Tokio-aware HTTP client.
///
...
pub struct Agent {
    ...
    bus_event_collector: crate::bus_event_collector::BusEventCollector,
...
impl Agent {
    pub fn new(resolved: ResolvedModel) -> Self {
        ...
        Self {
            ...
            #[cfg(feature = "blob-store")]
            blob_store: None,
            bus_event_collector: crate::bus_event_collector::BusEventCollector::new(),
    ...
    pub fn with_audit(mut self, audit: std::sync::Arc<crate::audit::AuditLog>) -> Self {
    ...
    pub fn add_tools(&mut self, tools: Vec<lattice_core::types::ToolDefinition>) {
    ...
    pub fn set_behavior(&mut self, mode: behavior::BehaviorMode) {
        ...
        if let Some(ref audit) = self.audit {
            audit.log_sync(crate::audit::AuditEvent::behavior_switch(
                &from,
                &to,
                "user_request",
            ));
    ...
    pub async fn with_permissive<Fut, T>(
        &mut self,
        f: impl FnOnce() -> Fut,
    ) -> Result<T, lattice_core::LatticeError>
    where
        Fut: std::future::Future<Output = Result<T, lattice_core::LatticeError>> + Send,
    {
    ...
    pub fn messages(&self) -> &[lattice_core::types::Message] {
        &self.state.messages
    }
    ...
    pub fn seed_messages(&mut self, messages: Vec<lattice_core::types::Message>) {
    ...
    > {
        ...
        loop {
            match lattice_core::chat_with_effort(
                &self.state.resolved,
                &self.state.messages,
                &self.tools,
...
pub enum LoopEvent {
    ...
    ToolResult {
        call: lattice_core::types::ToolCall,
        result: String,
    },
    Done {
...
mod tests {
    ...
    async fn test_bus_fetch_tool_execution() {
        ...
        let call = lattice_core::types::ToolCall {
            id: "call-1".to_string(),
            function: lattice_core::types::FunctionCall {
    ...
    async fn test_with_permissive_switches_and_restores_on_ok() {
        ...
        let result = agent
            .with_permissive(|| async {
                ...
                Ok::<_, lattice_core::LatticeError>(42)
            })
            .await;
    ...
    async fn test_with_permissive_restores_on_err() {
        ...
        let result: Result<(), _> = agent
            .with_permissive(|| async {
                Err(lattice_core::LatticeError::Config {
    ...
    async fn test_with_permissive_preserves_custom_strict() {
        ...
        let result = agent
            .with_permissive(|| async { Ok::<_, lattice_core::LatticeError>("done") })
            .await;
