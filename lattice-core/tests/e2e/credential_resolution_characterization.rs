...
use lattice_core::catalog::{ApiProtocol, CatalogProviderEntry};
use lattice_core::router::{normalize_model_id, ModelRouter, PROVIDER_CREDENTIALS_RAW};
...
fn resolve_credentials_prefers_entry_credential_keys_over_fallback() {
    ...
    use lattice_core::catalog::ModelCatalogEntry;
